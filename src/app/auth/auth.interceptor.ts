...
let isRereshing$ = new BehaviorSubject<boolean>(false)
...
const refreshAndProceed = (authService: AuthService,
    ...
    return isRereshing$.pipe(
        filter(isRereshing$ => !isRereshing$),
        switchMap(res =>{
